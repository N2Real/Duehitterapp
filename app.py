...
def update_data():
    ...
    for _, game in games_df.iterrows():
        if game['status'] in ['Preview', 'Live', 'In Progress']:
            ...
            players = [
                {"name": "Juan Soto", "team": game.get('away', 'NYY'), "proj_hits": 1.2, "proj_walks": 0.8, "live_hits": 0, "live_walks": 0, "walk_prob": 28, "due_score": 92, "hit_prob": 47, "babip": 0.341, "hard_hit": 52.7, "woba_vs_p": 0.478, "why": "Hot recent form + elite PvP wOBA"},
                {"name": "Aaron Judge", "team": game.get('home', 'NYY'), "proj_hits": 1.1, "proj_walks": 0.6, "live_hits": 0, "live_walks": 0, "walk_prob": 22, "due_score": 88, "hit_prob": 45, "babip": 0.328, "hard_hit": 55, "woba_vs_p": 0.455, "why": "Multiple outs + high hard hit rate"},
                {"name": "Mookie Betts", "team": game.get('away', 'LAD'), "proj_hits": 1.0, "proj_walks": 0.7, "live_hits": 0, "live_walks": 0, "walk_prob": 25, "due_score": 84, "hit_prob": 42, "babip": 0.328, "hard_hit": 46.8, "woba_vs_p": 0.412, "why": "Walk logged + excellent BvP"},
            ]
            top_games.append({
...
st.divider()
st.caption("statsapi integration + all approved features kept. Refresh button for 11AM ET. Your full rules applied.")