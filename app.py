...
st.caption("All Features • wOBA • BABIP • Hard Hit • Live Stats • Your Rules")
...
st.divider()
st.caption("All approved features kept: wOBA vs Pitcher, BABIP, Hard Hit, Projected/Live Hits/Walks, Walk Prob, Why reasoning, Top games. Your full rules applied.")